...
LOG_PP_INFO(my_logger, {"target"}, std::initializer_list<log_pp::BasicKV<char>>{{"k", 1}});  // message omitted
LOG_PP_INFO(my_logger, std::initializer_list<log_pp::BasicKV<char>>{{"k", 1}});               // message + target omitted
```
...
LOG_PP_INFO("value={}", 1);
LOG_PP_INFO({"target"}, std::initializer_list<log_pp::BasicKV<char>>{{"k", 1}});  // message omitted
LOG_PP_INFO(std::initializer_list<log_pp::BasicKV<char>>{{"k", 1}});               // message + target omitted
```
